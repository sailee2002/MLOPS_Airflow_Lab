...
def perform_eda(data):
    ...
    Generates summary statistics and basic insights.

    Args:
        data (bytes): Serialized data to be analyzed.

    Returns:
        bytes: Returns the same serialized data to pass to next task.
    """
    ...
    print(f"\nSummary Statistics for BALANCE, PURCHASES, CREDIT_LIMIT:")
    print(df[["BALANCE", "PURCHASES", "CREDIT_LIMIT"]].describe())
    ...
    # Return the same data to pass to preprocessing
    return data    
